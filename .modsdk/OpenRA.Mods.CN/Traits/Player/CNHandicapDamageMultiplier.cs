...
{
	[Desc("Modifies the damage applied to this actor based on the owner's named handicap tier (Easy/Normal/Hard/Brutal).")]
	...
	public class CNHandicapDamageMultiplier : IDamageModifier
	{
		readonly CNHandicapDamageMultiplierInfo info;
		readonly Actor self;

		public CNHandicapDamageMultiplier(CNHandicapDamageMultiplierInfo info, Actor self)
		{
			this.info = info;
			this.self = self;
		}
